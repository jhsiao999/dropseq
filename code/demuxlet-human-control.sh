...
dir_bam_indexed="/project2/gilad/joycehsiao/dropseq-pipeline/bam_indexed/Aligned.SortedByCoordinate.out.bam"
dir_vcf="/project2/gilad/joycehsiao/dropseq-pipeline/genotypes-multiple"
dir_output="/project2/gilad/joycehsiao/dropseq-pipeline/genotypes-human-control-output"
