...
dir_temp_scene="/project2/gilad/joycehsiao/dropseq-pipeline/genotypes-18489-tmp-scene-4"
dir_pseudo="/project2/gilad/joycehsiao/dropseq-pipeline/genotypes-18489-pseudo-scene-4"
...
# 1. keep sites if ancestral allele is either identifeid as
# present or absent
